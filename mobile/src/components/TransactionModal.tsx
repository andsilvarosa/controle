...
export function TransactionModal() {
  const { activeModal, setActiveModal, addTransaction, wallets, categories } = useFinanceStore();
    ...
    >
      <View className="flex-1 justify-end bg-black/50">
        ...
        >
          ...
          <TouchableOpacity
            onPress={handleSave}
            className={`py-4 rounded-xl items-center ${activeModal === 'income' ? 'bg-green-600' : 'bg-red-600'}`}
          >
